...
##' Return the comments retrieved by the authenticating user.
##' 
...
##' } 
##' 
##' @title Return comments the authenticating user received
...
##' @export
##' @references \url{http://open.weibo.com/wiki/index.php/Statuses/comments_to_me/en}
##' @keywords ROAuth
##' @examples \dontrun{
##' 
##' timeline.CommentsToMe(roauth, list(count = 5))
##' }
timeline.CommentsToMe <- function(roauth, params=list(), requestURL = "http://api.t.sina.com.cn/statuses/comments_to_me.json") {
