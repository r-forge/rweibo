...
##' Return recommend user list created by the system.
##' 
##' The argument "params" should be a list which cantains:
##' 
##' \tabular{ll}{ 
##' category \tab Category, return a certain kind recommend user, default is by default.\cr 
##' } 
##' 
##' @title Return system recommended users
...
##' @export
##' @references \url{http://open.weibo.com/wiki/index.php/Users/hot/en}
##' @keywords ROAuth
##' @examples \dontrun{
##' 
##' user.Hot(roauth)
##' }
user.Hot <- function(roauth, params=list(), requestURL = "http://api.t.sina.com.cn/users/hot.json") {
